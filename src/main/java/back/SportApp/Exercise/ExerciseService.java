...
import back.SportApp.Repository.ExerciseRepository;
...
@Service
public class ExerciseService implements tableService<Exercise>{
    ...
    @Override
    public Exercise lireById(Integer id) {
    ...
    @Override
    public Exercise modifier(Integer id, Exercise exercise) {
